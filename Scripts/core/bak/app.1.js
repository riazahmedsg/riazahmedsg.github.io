...
(function () {
  ...
  //     if (this.status === 200) {
  //       if (this.readyState === 4) {
  //         projectbook = JSON.parse(this.responseText);
    ...
    XHR.addEventListener("readystatechange", function () {
      if (this.status === 200) {
        if (this.readyState === 4) {
          ...
          console.log(`Skill2 name: ${skills.skill2.name}`);
          console.log(`Skill2 details: ${skills.skill2.details}`);
          //Skills for HTML
          if (document.title == "Contact") {
            //alert("On Contact Page");
            document.getElementById("name1").textContent = skills.skill1.name;
            document.getElementById("detail1").textContent = skills.skill1.details;
            document.getElementById("name2").textContent = skills.skill2.name;
            document.getElementById("detail2").textContent = skills.skill2.details;
            // let name1d = skills.skill1.name;
            // name1.innerHTML = name1d;

          }



          // document.getElementById(detail1).innerHTML = skills.skill1.details;
          // document.getElementById(name2).innerHTML = skills.skill2.name;
          // document.getElementById(detail2).innerHTML = skills.skill2.details;
        }
      }
    });
  ...
  //   projectbook.Projects.forEach(project => {
  //     let newProject = new objects.Project(
  ...
  //   let project1 = Projects.Project1.name;
  ...
  //   projectbook.Contacts.forEach(contact => {
